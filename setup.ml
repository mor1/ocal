...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7a0d67a13e20cc7846d48a9777f97ba) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/mor1/ocaml-cal";
          synopsis = "Unix `cal` replacement";
          description =
            Some
              [
                 OASISText.Para
                   "A replacement for the standard Unix `cal` utility. Partly because I could, partly because I'd become too irritated with its command line interface."
              ];
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ocal.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "d\144u\\ä\020b\000z\027\138ÿ?mûZ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
